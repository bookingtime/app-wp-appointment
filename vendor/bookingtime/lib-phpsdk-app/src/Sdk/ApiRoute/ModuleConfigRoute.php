...
class ModuleConfigRoute extends Route {
	...
	public function add(array $urlParameter,array $requestContent,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('POST','/organization/'.$urlParameter['organizationId'].'/moduleConfig/add',$requestContent,$expectedResponseCode);
	...
	public function index(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/moduleConfig/'.($all?'indexAll':'index').'/'.($urlParameter['page']?$urlParameter['page']:'1'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function filter(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/moduleConfig/'.($all?'filterAll':'filter').'/'.($urlParameter['page']?$urlParameter['page']:'1').'?searchQuery='.$urlParameter['searchQuery'],[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function list(array $urlParameter,$all,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId'],$urlParameter);
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/moduleConfig/'.($all?'listAll':'list'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function edit(array $urlParameter,array $requestContent,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','moduleConfigId'],$urlParameter);
		$response=$this->httpClient->request('PUT','/organization/'.$urlParameter['organizationId'].'/moduleConfig/'.$urlParameter['moduleConfigId'].'/edit',$requestContent,$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function delete(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','moduleConfigId'],$urlParameter);
		$response=$this->httpClient->request('DELETE','/organization/'.$urlParameter['organizationId'].'/moduleConfig/'.$urlParameter['moduleConfigId'].'/delete',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
}
