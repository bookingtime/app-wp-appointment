 ...
 */
class CustomerGroupRoute extends Route {
	...
	public function add(array $urlParameter,array $requestContent,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('POST','/organization/'.$urlParameter['organizationId'].'/customerGroup/add',$requestContent,$expectedResponseCode);
	...
	public function show(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','customerGroupId'],$urlParameter);
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.$urlParameter['customerGroupId'].'/show',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function identify(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.$urlParameter['customId'].'/identify',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function index(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.($all?'indexAll':'index').'/'.($urlParameter['page']?$urlParameter['page']:'1'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function filter(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.($all?'filterAll':'filter').'/'.($urlParameter['page']?$urlParameter['page']:'1').'?searchQuery='.$urlParameter['searchQuery'],[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function list(array $urlParameter,$all,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId'],$urlParameter);
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.($all?'listAll':'list'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function edit(array $urlParameter,array $requestContent,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','customerGroupId'],$urlParameter);
		$response=$this->httpClient->request('PUT','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.$urlParameter['customerGroupId'].'/edit',$requestContent,$expectedResponseCode);
	...
	public function delete(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','customerGroupId'],$urlParameter);
		$response=$this->httpClient->request('DELETE','/organization/'.$urlParameter['organizationId'].'/customerGroup/'.$urlParameter['customerGroupId'].'/delete',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
}
